...
import { Challenge, Lesson } from "@/db/schema";

type LessonFormProps = {
  lesson: Lesson & { challenges: Challenge[] };
  unitId: number;
};

export const LessonForm = ({ lesson, unitId }: LessonFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/courses/edit/lesson`, {
        method: "PATCH",
        headers: {
